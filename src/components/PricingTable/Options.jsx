  ...
  <table className={styles.priceTable}>
      <tbody>
          ...
          <tr className={styles.priceTableHead}>
              ...
              <td>
                 Optimizer
                  <br /><small style={{fontSize: `12px`, fontWeight: `400`}}>Growth and retention</small>
              </td>
              <td className={styles.greenWidth}>
              Accelerator
                  <br /><small style={{fontSize: `12px`, fontWeight: `400`}}>Next Level Growth</small>
              </td>
              <td className={styles.greenWidth}>
                  Ultra
                  <br /><small style={{fontSize: `12px`, fontWeight: `400`}}>Next Level Growth</small>
          ...
          <tr>
              <td><a href="#wordpress-billing" className={styles.priceTableHelp}>
                <i className="far fa-fw fa-question-circle"></i>
                <FaQuestionCircle  />
                </a> Easy Billing + No Contracts</td>
                <td><FaCheck /></td>
                <td><FaCheck /></td>
                <td><FaCheck /></td>
                <td><FaTimes /></td>
